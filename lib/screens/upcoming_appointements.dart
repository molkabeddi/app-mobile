...
class UpcomingAppointements extends StatefulWidget {
  final String status;
  const UpcomingAppointements({Key? key, required this.status}) : super(key: key);

  @override
  State<UpcomingAppointements> createState() => _UpcomingAppointementsState();
}

class _UpcomingAppointementsState extends State<UpcomingAppointements> {
  @override
